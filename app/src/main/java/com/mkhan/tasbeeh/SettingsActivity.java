...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            System.out.println("Mohseen : Preference : OnPreferenceChangeListener" + preference);
    ...
    public void onBuildHeaders(List<Header> target) {
        System.out.println("Mohseen : SettingActivity : onBuildHeaders");
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            System.out.println("Mohseen : NotificationPreferenceFragment : onCreate");
            super.onCreate(savedInstanceState);
        ...
        @Override
        public boolean onOptionsItemSelected(MenuItem item) {
            System.out.println("Mohseen : NotificationPreferenceFragment : onOptionsItemSelected");
            int id = item.getItemId();
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), SettingsActivity.class));
                return true;
